    ...
    const handleLoginSuccess = async (response) => {
        ...
        try {
          ...
          const res = await fetch(endpoint, {
            ...
            sessionStorage.setItem("userId", data.data?.studentId || data.data?.professorId);
    ...
    return (
        <div className="loginContainer">
            ...
            <div className="text-center">
                <i className="bi bi-mortarboard text-light" style={{ fontSize: "2rem" }}></i>
            </div>
            ...
            <div className="text-center mb-4">
                ...
                <div className="roleSwitch">
                    <span
                        className={`roleOption ${role === "STUDENT" ? "activeOption" : "inactiveOption"}`}
                        onClick={() => {
                            setRole("STUDENT");
                            setError(null);
                        }}
                    ...
                    <span
                        className={`roleOption ${role === "PROFESOR" ? "activeOption" : "inactiveOption"}`}
                        onClick={() => {
                            setRole("PROFESOR");
                            setError(null);
                        }}
